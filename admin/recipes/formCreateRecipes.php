...
$allergie_3 = $_POST['allergie_3'];
$onlyUsers = $_POST['onlyUsers'];

$statement = $pdo->prepare('INSERT INTO diet(titre, temps_preparation, temps_cuisson ,ingredient ,etape ,description ,allergie_1, allergie_2, allergie_3,onlyAdmin ) VALUES (:titre, :temps_preparation, :temps_cuisson ,:ingredient ,:etape ,:description ,:allergie_1, :allergie_2, :allergie_3, :onlyAdmin )');
$statement->bindValue(':titre', $titre);
$statement->bindValue(':temps_preparation', $time_preparation);
$statement->bindValue(':temps_cuisson', $cooking_time);
$statement->bindValue(':ingredient', $ingredients);
$statement->bindValue(':etape', $steps);
$statement->bindValue(':description', $description);
$statement->bindValue(':allergie_1', $allergie_1);
$statement->bindValue(':allergie_2', $allergie_2);
$statement->bindValue(':allergie_3', $allergie_3);
$statement->bindValue(':onlyAdmin', $onlyUsers);

if ($statement->execute()) {
    $message ='La recette a bien été créé ! ';
} else {
