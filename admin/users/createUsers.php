...
<html>
  <head>
    ...
    <title>Cree un utilisateur</title>
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm" id="navbar">
    <div class="container">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-egg-fill me-2" viewBox="0 0 16 16" >
        ...
        <strong>Cree un utilisateur</strong>
      </a>
  ...
  <main>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-7 col-lg-8">
        <h4 class="mb-3">Creation d'un utilisateur</h4>
        <form class="needs-validation" method="POST" action="./formUsers.php" >
          <div class="row g-3 ">
            <div class="col-sm-6">
            ...
            <div class="col-12">
              <label for="address" class="form-label">Suivi 1</label>
              <input type="text" class="form-control" id="suivi_1" name='suivi_1' >
              <div class="invalid-feedback"
            ...
            <div class="col-12">
              <label for="address" class="form-label">Suivi 2</label>
              <input type="text" class="form-control" id="suivi_" name='suivi_2'>
              <div class="invalid-feedback"
                Please enter hi follow -up.
              </div>
            </div>
          ...
          <hr class="my-4">
          <button class="w-100 btn btn-primary btn-lg" type="submit">Créé un utilisateur</button>
        </form>
      </div>
    </div>
  </main>
