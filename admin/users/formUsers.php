...
$suivi_1 = $_POST['suivi_1'] ;
$suivi_2 = $_POST['suivi_2'] ;
$password = $_POST['password'] ;

$statement = $pdo->prepare('INSERT INTO users(email, allergie, password,nom ,prenom ,suivi_1 ,suivi_2 ) VALUES (:email, :allergie, :password, :nom, :prenom, :suivi_1, :suivi_2)');
$statement->bindValue(':email', $email);
$statement->bindValue(':allergie', $allergie);
$statement->bindValue(':password', password_hash($password, PASSWORD_BCRYPT));
$statement->bindValue(':nom', $lastname);
$statement->bindValue(':prenom', $name);
$statement->bindValue(':suivi_1', $suivi_1);
$statement->bindValue(':suivi_2', $suivi_2);
