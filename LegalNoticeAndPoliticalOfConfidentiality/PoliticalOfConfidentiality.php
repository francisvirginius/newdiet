...
<link href="./LegalNoticeAndConfidentiality.css" rel="stylesheet" type="text/css" />
  </head>
      ...
      <div class="row">
        ...
        <div class="col-sm-4 offset-md-1 py-4">
          <ul class="list-unstyled">
            ...
            <li><a href="./LegalNotice.php" class="text-white">Mentions légales</a></li>
            <li><a href="./PoliticalOfConfidentiality.php" class="text-white">Politique de confidentialité</a></li>
          </ul>
        </div>
      </div>
    </div>
